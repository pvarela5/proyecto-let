---
title: "Análisis venta de autos usados y modelos para predecir su precio"
...
```{r}
#| fig-cap: "Año de produccón del auto"
#| label: fig-años
...
Además observamos que la mayoría de los vehículos fueron fabricados alredor del año 2000.
